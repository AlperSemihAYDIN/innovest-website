  ...
  return (
    <>
      ...
      <div className="hidden lg:block bg-[#0c0c10]">
        <div className="px-12 md:px-16 lg:px-24 xl:px-40 2xl:px-56 py-3 flex items-center justify-between text-[11px] tracking-[0.08em] text-white/60">
      ...
      >
        <div className="px-12 md:px-16 lg:px-24 xl:px-40 2xl:px-56 flex items-center h-[72px]">
