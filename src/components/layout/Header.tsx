  ...
  return (
    <>
      ...
      <div className="hidden lg:block bg-[#0c0c10]">
        <div className="px-4 sm:px-6 md:px-8 lg:px-12 py-3 flex items-center justify-between text-[11px] tracking-[0.08em] text-white/60">
      ...
      >
        <div className="px-4 sm:px-6 md:px-8 lg:px-12 flex items-center h-[72px]">
