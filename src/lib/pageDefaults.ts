...
export const homeDefaults: HomePageContent = {
  hero: {
    titleEn: 'Investing in',
    titleTr: 'Geleceğe',
    titleHighlightEn: 'Opportunity',
    titleHighlightTr: 'Yatırım',
    subtitleEn:
  ...
  stats: [
    ...
    { value: '25+', labelEn: 'Countries', labelTr: 'Ülke' },
    { value: '500+', labelEn: 'Investors', labelTr: 'Yatırımcı' },
    { value: '98%', labelEn: 'Client Satisfaction', labelTr: 'Müşteri Memnuniyeti' },
  ],
  services: {
    taglineEn: 'Our Expertise',
    taglineTr: 'Uzmanlığımız',
    ...
    items: [
      {
        titleEn: 'Real Estate',
        titleTr: 'Gayrimenkul',
        descEn: 'Premium properties in London, Dubai and major global markets.',
        descTr: 'Londra, Dubai ve büyük küresel pazarlarda premium mülkler.',
        ctaEn: 'Discover →',
        ctaTr: 'Keşfet →',
      },
      {
        ...
        descEn: 'Golden Visa, citizenship by investment and residency programmes.',
        descTr: 'Altın Vize, yatırım yoluyla vatandaşlık ve oturum programları.',
        ctaEn: 'Discover →',
        ctaTr: 'Keşfet →',
      },
      {
        titleEn: 'Business Expansion',
        titleTr: 'İş Genişleme',
        descEn: 'Strategic guidance for UK, EU and UAE market entry.',
        descTr: 'İngiltere, AB ve BAE pazarına giriş için stratejik rehberlik.',
        ctaEn: 'Discover →',
        ctaTr: 'Keşfet →',
      },
    ],
  ...
  cta: {
    titleEn: 'Ready to Begin Your',
    titleTr: 'Yatırım Yolculuğunuza',
    titleHighlightEn: 'Investment Journey?',
    titleHighlightTr: 'Başlamaya Hazır mısınız?',
    subtitleEn: 'Schedule a complimentary consultation to discuss your goals.',
    subtitleTr: 'Hedeflerinizi görüşmek için ücretsiz bir danışmanlık görüşmesi planlayın.',
    buttonEn: 'Get Free Consultation',
    buttonTr: 'Ücretsiz Danışmanlık Al',
    noteEn: 'No obligation · Confidential · Worldwide',
