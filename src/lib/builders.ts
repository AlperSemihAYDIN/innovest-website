...
export const LONDON_BUILDERS: Builder[] = [
  ...
  { name: 'Knight Dragon', logo: '/builders/london/knight-dragon.jpg', alt: 'Knight Dragon' },
  { name: 'London Square', logo: '/builders/london/london-square.jpg', alt: 'London Square' },
];

export const DUBAI_BUILDERS: Builder[] = [
  { name: 'Aldar', logo: '/builders/dubai/aldar.svg', alt: 'Aldar' },
  { name: 'Binghatti', logo: '/builders/dubai/binghatti.png', alt: 'Binghatti' },
